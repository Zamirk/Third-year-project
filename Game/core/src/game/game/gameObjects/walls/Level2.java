...
public class Level2 extends WorldObject implements Constants {
    AssetManager manager;
    public Level2(AssetManager manager, World world, TiledMap map, Rectangle bounds){
        super(world, map, bounds);
        fixture.setUserData(this);
        setCategoryFilter(LEVEL2_BIT);
