...
public class Level1 extends LevelAbstract {
    ...
    public Level1(Difficulty a,SpriteBatch sb, AssetManager managerIn, Hud hud, boolean retro) {
        manager = managerIn;
        this.retro = retro;
        this.hud = hud;
        this.sb = sb;
       ...
       // Music music = manager.get("audio/music/Antigravity.mp3", Music.class);
        ...
        map = mapLoader.load("levels/level9.tmx");
