...
public class Level2 extends LevelAbstract {
    ...
    public Level2(Difficulty a, SpriteBatch sb, AssetManager managerIn, Hud hud, boolean retro) {
        manager = managerIn;
        this.retro = retro;
        this.hud = hud;
        this.sb = sb;
       ...
       // Music music = manager.get("audio/music/Antigravity.mp3", Music.class);
        ...
        map = mapLoader.load("levels/level10.tmx");
